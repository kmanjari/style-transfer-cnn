...
# Style Image
style_image = Image.open('images/style/' + imageStyle)
...
for i in range(iterations):
    ...
    pusher.trigger('notify', 'result-'+imageLocation, {'status' : 'not complete', 'percentage': percentage, 'progress_message': str(i+1) +' out of ' + str(iterations) +' iterations has been completed'})
...
pusher.trigger('notify', 'result-'+imageLocation, {'status': 'complete', 'image': imageLocation + '-final.'+imageExtension})
